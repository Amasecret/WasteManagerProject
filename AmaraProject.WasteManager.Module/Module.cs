...
namespace AmaraProject.WasteManager.Module
{
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed partial class WasteManagerModule : ModuleBase
    {
        static WasteManagerModule()
        {
            ...
            // #if DEBUG
            // Database.SetInitializer(new DropCreateDatabaseIfModelChanges<WasteManagerDbContext>());
            // #endif 
        }
        public WasteManagerModule()
        {
            InitializeComponent();
